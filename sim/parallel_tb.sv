...
#(
    ...
    parameter bit VENABLEP              = 1'b1,
    /* verilator lint_on WIDTHTRUNC */
    parameter int VLENP                 = 128,      
    parameter int LLENP                 = 32,
    parameter int BUS_WIDTHP            = 32,
    parameter string BIN_FILEP          = "../app/lmfrnet/lmfrnet.bin",
    parameter string RESULTS_DIR        = "./results/",
    parameter string DEBUG_DIR          = "./debug/"
) (
);
...
//////////////////////////////////////////////////////////////////////////////
    ...
    localparam bit           VEnable         = VENABLEP;
    localparam int           VLEN            = VLENP;
    localparam int           LLEN            = LLENP;

`ifndef SYNTH
    localparam bit           PROFILING       = 1'b1;
    localparam bit           DEBUG           = 1'b1;
`endif
    localparam string        PROFILING_FILE  = {RESULTS_DIR, "Report.txt"};
    localparam string        OUTPUT_FILE     = {RESULTS_DIR, "Output.txt"};

    localparam int           BUS_WIDTH       = BUS_WIDTHP;
    localparam int           MEM_ADDR_BITS   = 28;
    localparam string        BIN_FILE        = BIN_FILEP;
