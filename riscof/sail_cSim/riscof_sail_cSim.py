...
class sail_cSim(pluginTemplate):
    ...
    def runTests(self, testList, cgf_file=None):
        ...
        for file in testList:
            ...
            config_file = os.path.join(self.pluginpath, 'sail_cfg.json')

            execute += self.sail_exe[self.xlen] + ' --config {} --test-signature={} {} > {}.log 2>&1;'.format(config_file, sig_file, elf, test_name)
