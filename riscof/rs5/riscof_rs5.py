...
class rs5(pluginTemplate):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dut_exe = os.path.join(config['PATH'] if 'PATH' in config else "","rs5")
    ...
    def build(self, isa_yaml, platform_yaml):
      ...
      # for rs5 start building the '--isa' argument. the self.isa is dutnmae specific and may not be
      # useful for all DUTs
    ...
    def runTests(self, testList):
	  ...
	  # echo statement.
          if self.target_run:
            ...
            symbols = subprocess.check_output(["riscv64-elf-readelf", elf, "-s"]).split(b'\n')[3:]
            ...
            objcopycmd = f'riscv64-elf-objcopy {elf} test.bin -O binary' 
