...
void TEST_CASE2(void) {
  VSET(14, e8, m1);
  asm volatile("vle8.v v1, (%0)" ::"r"(&ALIGNED_I8[2]));
  VCMP_U8(2, v1, 0x40, 0xd1, 0x84, 0x48, 0x89, 0x88, 0x88, 0xae, 0x08,
          0x91, 0x02, 0x59, 0x11, 0x89);
}
...
void TEST_CASE3(void) {
  VSET(13, e8, m1);
  asm volatile("vle8.v v1, (%0)" ::"r"(&ALIGNED_I8[3]));
  VCMP_U8(3, v1, 0xd1, 0x84, 0x48, 0x89, 0x88, 0x88, 0xae, 0x08,
          0x91, 0x02, 0x59, 0x11, 0x89);
}
...
void TEST_CASE4(void) {
  ...
  VCMP_U16(4, v1, 0xbbd3, 0x3840, 0x8cd1, 0x9384, 0x7548, 0x3489, 0x9388,
           0x8188, 0x11ae, 0x5808, 0x4891, 0x4902, 0x8759, 0x1111, 0x1989);
}

void TEST_CASE5(void) {
  VSET(14, e16, m1);
  asm volatile("vle16.v v1, (%0)" ::"r"(&ALIGNED_I16[2]));
  VCMP_U16(5, v1, 0x3840, 0x8cd1, 0x9384, 0x7548, 0x3489, 0x9388,
           0x8188, 0x11ae, 0x5808, 0x4891, 0x4902, 0x8759, 0x1111, 0x1989);
}

void TEST_CASE6(void) {
  VSET(13, e16, m1);
  asm volatile("vle16.v v1, (%0)" ::"r"(&ALIGNED_I16[3]));
  VCMP_U16(6, v1, 0x8cd1, 0x9384, 0x7548, 0x3489, 0x9388,
           0x8188, 0x11ae, 0x5808, 0x4891, 0x4902, 0x8759, 0x1111, 0x1989);
}
...
void TEST_CASE7(void) {
  ...
  VCMP_U32(7, v1, 0xf9aa71f0, 0xa11a9384, 0x99991348, 0x9fa831c7, 0x38197598,
...
void TEST_CASE8(void) {
  VSET(14, e32, m1);
  asm volatile("vle32.v v1, (%0)" ::"r"(&ALIGNED_I32[2]));
  VCMP_U32(8, v1, 0xa11a9384, 0x99991348, 0x9fa831c7, 0x38197598,
           0x18931795, 0x81937598, 0x18747547, 0x3eeeeeee, 0x90139301,
           0xab8b9148, 0x90318509, 0x31897598, 0x83195999, 0x89139848);
}
...
void TEST_CASE9(void) {
  VSET(13, e32, m1);
  asm volatile("vle32.v v1, (%0)" ::"r"(&ALIGNED_I32[3]));
  VCMP_U32(9, v1, 0x99991348, 0x9fa831c7, 0x38197598,
           0x18931795, 0x81937598, 0x18747547, 0x3eeeeeee, 0x90139301,
           0xab8b9148, 0x90318509, 0x31897598, 0x83195999, 0x89139848);
}
...
void TEST_CASE10(void) {
  ...
  // VCMP_U64(10, v1, 0xf9aa71f0c394bbd3, 0xa11a9384a7163840, 0x99991348a9f38cd1,
